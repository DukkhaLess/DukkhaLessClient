...
component localiseFn = H.component { initialState: const localiseFn
                                   , render
                                   , eval
    ...
    render state = let pageTitle = state $ Term.Intro Intro.Title
                       
                       pageExplanation = state $ Term.Intro Intro.Explanation
                       
                   in HH.section [ HP.classes [ hero
                                              ]
                                 ] [ HH.div [ HP.classes [ heroBody
                                                         ]
                                            ] [ HH.div [ HP.classes [ container
                                                                    ]
                                                       ] [ HH.h1 [ HP.classes [ title
                                                                              ]
                                                                 ] [ HH.text pageTitle
                                                                   ]
                                                         , HH.h2 [ HP.classes [ subtitle
                                                                              ]
                                                                 ] [ HH.text pageExplanation
                                                                   ]
                                                         ]
                                              ]
                                   ]
